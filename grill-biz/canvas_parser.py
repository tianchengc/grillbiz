...
def generate_html(data, output_path):
    """
    Generate a beautifully styled HTML file using CSS Grid with a Light/Dark theme toggle.
    """
...
<head>
    ...
    <title>Lean Canvas - {data['title']}</title>
    ...
    <style>
        ...
        [data-theme="light"] {{
            ...
            --sub-bg: rgba(0, 0, 0, 0.02);
            --sub-border: rgba(0, 0, 0, 0.04);
        }}
        ...
        * {{
        ...
        @media (max-width: 1024px) {{
            ...
            .card-problem, .card-segments, .card-uvp, .card-solution, .card-metrics, .card-advantage, .card-channels {{
                grid-column: span 1;
                grid-row: span 1;
            }}
            .bottom-grid {{
    ...
    <div class="container">
        ...
        <div class="canvas-grid">
            ...
            <div class="card card-problem">
                ...
                {f'<div class="sub-section"><div class="sub-title">Existing Alternatives</div><div class="sub-content">{data["alternatives"]}</div></div>' if data["alternatives"] else ''}
            </div>
            ...
            <!-- 3. UVP -->
            <div class="card card-uvp">
                <div class="card-num">03</div>
                <div class="card-title">Unique Value Prop</div>
                <div class="card-content">
                    <ul>{data['uvp']}</ul>
                </div>
                {f'<div class="sub-section"><div class="sub-title">High-Level Concept</div><div class="sub-content">{data["concept"]}</div></div>' if data["concept"] else ''}
            </div>

            <!-- 9. UNFAIR ADVANTAGE -->
            <div class="card card-advantage">
                <div class="card-num">09</div>
                <div class="card-title">Unfair Advantage</div>
                <div class="card-content">
                    <ul>{data['advantage']}</ul>
                </div>
            </div>
            ...
            <!-- 2. CUSTOMER SEGMENTS -->
            <div class="card card-segments">
                <div class="card-num">02</div>
                <div class="card-title">Customer Segments</div>
                <div class="card-content">
                    <ul>{data['segments']}</ul>
                </div>
                {f'<div class="sub-section"><div class="sub-title">Early Adopters</div><div class="sub-content">{data["early_adopters"]}</div></div>' if data["early_adopters"] else ''}
            </div>
        </div>
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python3 canvas_parser.py <profile_name>")
        sys.exit(1)
